...
## Build Your Own Digital Haven
Looking to stash your notes, tasks, and guides without third-party prying eyes? Here is how to spin up your own vault.
...
4. **Lock It Down**  
   ...
   > **Security Check:** Immediately make sure `.vaultpass` is included in your `.gitignore` file. You definitely do not want to accidentally push your password to a public GitHub repository!
...
## Zero Liability and As-Is Disclaimer
...
> **Note:** Back up your unencrypted `src/` files securely. You have been warned.
...
1. **No Corporate or Monetization Exploitation**  
   This is a passion project built strictly on FOSS principles. Do not open issues requesting monetization methods, and do not submit PRs that introduce telemetry, tracking, paywalls, or "premium" features. Any attempts to commercialize this engine will be rejected, and the associated user will be blocked.
...
2. **Respect Privacy Context**  
   ...
   - Do not solicit access to private, personal collections.
...
4. **Forking and Personal Responsibility**  
...
5. **Community Conduct**  
   Keep all interactions in the issues tab focused, technical, and constructive. Harassment, spam, and toxic behavior are not tolerated. Let us respect FOSS and keep the project environment healthy and productive.
...
- **[PageCrypt (by Greenheart)](https://github.com/Greenheart/pagecrypt)**: Provides the essential client-side AES-GCM encryption that makes the "Vault" functionality possible. This project would not have this level of automated piping without Samuel Plumppu's specialized CLI rewrite.
